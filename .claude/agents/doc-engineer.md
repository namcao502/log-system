---
name: doc-engineer
description: Updates project documentation after a feature is implemented. Use as the final step to capture new patterns in CLAUDE.md or add changelog entries.
