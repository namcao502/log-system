---
name: plan-creator
description: Explores the codebase and produces a detailed file-by-file implementation plan for a feature or ticket. Use before any code is written to map out exactly which files need to be created or modified.
