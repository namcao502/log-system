---
name: qa-engineer
description: Writes automated Jest tests and a manual test checklist for a feature or ticket. Use after implementation is complete and code review has passed.
