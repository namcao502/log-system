---
name: be-engineer
description: Implements state logic and data layer changes for a feature or ticket in C:/TEST/log-system. Use for changes to lib/ files, hooks, types, or any non-UI logic.
